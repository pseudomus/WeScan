...
final class QuadrilateralView: UIView {
    ...
    private let quadLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor(named: "Rectangle")?.cgColor ?? UIColor.white.cgColor
        layer.lineWidth = 1.0
        layer.opacity = 1.0
        layer.isHidden = true
        return layer
    ...
    public var editable = false {
        didSet {
            ...
            quadLayer.fillColor = editable ? UIColor(named: "Rectangle")?.withAlphaComponent(0.1).cgColor : UIColor.systemPink.withAlphaComponent(0.1).cgColor
            guard let quad else {
                return
            }
